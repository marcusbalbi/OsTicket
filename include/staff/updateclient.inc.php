...
<table width="80%" border="0" cellspacing="1" cellpadding="2">
    <tr><td align="left" colspan=2>Preencha todos os campos para alterar o cliente,caso deseje manter a senha deixa em branco</td></tr>
    <tr>
        <td align="left" nowrap width="20%"><b><?php  $trl->_('LABEL_EMAIL_ADDRESS')?>:</b></td>
        <td>
            <input type="text" name="email" id="email" size="25" value="<?php echo $client->getEmail(); ?>" >
     ...
     <tr>
        ...
        <td>
            <input type="text" id="name" name="name" size="25" value="<?php echo $client->getName();?>">
    ...
    <tr>
        <td></td>
        <td>
            <input class="button" type="submit" name="submit_x" value="Alterar Cliente">
